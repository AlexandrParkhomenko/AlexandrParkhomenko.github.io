...
2. # Базовые тесты примитивов
    ...
    6. Резюме
3. # Иерархии ограничивающих объемов
...
5. # Иерархии деревьев BSP
    ...
    5. Резюме
6. # Основанные на выпуклости методы
    ...
    7. Резюме
7.  # Обнаружение столкновений с помощью GPU
...
$\vec F = m \vec a = m \frac{d \vec v}{dt}$ (6.4)
